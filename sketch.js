...
function draw() {
  ...
  textFont("italic");
  fill("brown")
  text("*WARNING*(^)=don't presss here to reset polygon full game will be reseted if you press that button",5,20)
  fill("black");
  textFont("bold");
  text("Drag And Release", 720,320);
  text("Press SPACE To Reset polygon only", 570,350);
  fill("white");
  text("(open in edge only)",30,370)
  textFont("algerian")
  fill("red")
  textSize(30)
  text("PROJECT BY R.RAM CHARAN",10,100)
